...
public delegate void GUIToggleButtonChanged( GUISpriteToggleButton sender, bool selected );

public class GUISpriteToggleButton : GUITouchableSprite
{
	public GUIToggleButtonChanged action = null; // Delegate for when we get a touchUpInside
	...
	public GUISpriteToggleButton( Rect frame, int depth, UVRect uvFrame, UVRect selectedUVframe ):base( frame, depth, uvFrame )
	{
	...
	public GUISpriteToggleButton( Rect frame, int depth, UVRect uvFrame, UVRect selectedUVframe, UVRect highlightedUVframe ):this( frame, depth, uvFrame, selectedUVframe )
	{
