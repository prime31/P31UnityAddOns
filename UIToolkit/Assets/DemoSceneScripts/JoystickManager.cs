...
public class JoystickManager : MonoBehaviour
{
	...
	void Start()
	{
		...
		UISprite leftJoystickSprite = new UISprite( new Rect( 10, 10, 100, 100 ), 1, new UVRect( 0, 0, 234, 234, textureSize ), true );
		
		leftJoystick = new UIJoystick( new Rect( 0, 120, 240, 200 ), 1, UVRect.zero, leftJoystickSprite, new Vector2( 240 / 2, -200 / 2 ) );
		...
		// Right Joystick		
		UISprite rightJoystickSprite = new UISprite( new Rect( 10, 10, 100, 100 ), 1, new UVRect( 250, 0, 234, 234, textureSize ), true );
		rightJoystick = new UIJoystick( new Rect( 240, 120, 240, 200 ), 1, UVRect.zero, rightJoystickSprite, new Vector2( 240 / 2, -200 / 2 ) );
		rightJoystick.highlightedUVframe = new UVRect( 250, 240, 234, 234, textureSize );
		rightJoystick.addBackgroundSprite( new Rect( 0, 0, 120, 120 ), 50, new UVRect( 250, 500, 305, 305, textureSize ) );
